 ...
 */
public class GridAdaptar extends RecyclerView.Adapter<GridAdaptar.ContactViewHolder> {
    ArrayList<Grid> contacts = new ArrayList<Grid>();

    public GridAdaptar(ArrayList<Grid> contacts){
    ...
    public void onBindViewHolder(ContactViewHolder holder, int position) {
        ...
        Grid con = contacts.get(position);
