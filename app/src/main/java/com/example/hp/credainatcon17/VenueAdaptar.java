 ...
 */
public class VenueAdaptar extends RecyclerView.Adapter<VenueAdaptar.ContactViewHolder> {
    ArrayList<Venue> contacts = new ArrayList<Venue>();

    public VenueAdaptar(ArrayList<Venue> contacts){
    ...
    public void onBindViewHolder(ContactViewHolder holder, int position) {
        ...
        Venue con = contacts.get(position);
